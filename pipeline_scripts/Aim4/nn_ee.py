...
plt.savefig("nn_training_loss_ee.png", dpi=300)
plt.close()
...
metrics_df.to_csv("nn_model_metrics_ee.csv", index=False)
...
plt.legend()
plt.savefig("nn_roc_curve_ee.png", dpi=300)
plt.close()
...
results.to_csv("nn_predictions_ee.csv", index=False)