...
train = pd.read_csv("../pipeline_outputs/train_baseline_ee_onehot.csv")  #change file names accordingly
test = pd.read_csv("../pipeline_outputs/test_baseline_ee_onehot.csv")
...
metrics_df.to_csv("rf_model_metrics_ee.csv", index=False)
...
results_df.to_csv("rf_results_ee.csv", index=False)
...
plt.tight_layout()
plt.savefig("rf_roc_curve_ee.png", dpi=300)
plt.close()
...
importance_df.to_csv("rf_feature_importance_ee.csv", index=False)
...
plt.tight_layout()
plt.savefig("rf_feature_importance_ee.png", dpi=300)
plt.close()
