...
ukb_train = pd.read_csv("../pipeline_outputs/ukb_train_baseline.csv")  #change file names accordingly
ukb_test = pd.read_csv("../pipeline_outputs/ukb_test_baseline.csv")
...
result_path = os.path.join(output_dir, "logistic_test_results_baseline.txt")
...
roc_path = os.path.join(output_dir, "logistic_roc_curve_baseline.png")
