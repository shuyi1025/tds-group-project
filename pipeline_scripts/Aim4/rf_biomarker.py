...
results_df.to_csv("rf_results_biomarker.csv", index=False)
...
plt.tight_layout()
plt.savefig("rf_roc_curve_biomarker.png", dpi=300)
plt.close()
...
importance_df.to_csv("rf_feature_importance_biomarker.csv", index=False)
...
plt.tight_layout()
plt.savefig("rf_feature_importance_biomarker.png", dpi=300)
plt.close()
