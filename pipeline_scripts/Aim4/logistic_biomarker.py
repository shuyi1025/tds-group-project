...
ukb_train = pd.read_csv("../pipeline_outputs/train_ee_bio_stable_allclusters.csv")  #change file names accordingly
ukb_test = pd.read_csv("../pipeline_outputs/test_ee_bio_stable_allclusters.csv")
...
result_path = os.path.join(output_dir, "logistic_test_results_biomarker.txt")
...
roc_path = os.path.join(output_dir, "logistic_roc_curve_biomarker.png")
