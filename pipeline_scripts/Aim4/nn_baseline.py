...
plt.savefig("nn_training_loss_baseline.png", dpi=300)
plt.close()
...
metrics_df.to_csv("nn_model_metrics_baseline.csv", index=False)
...
plt.legend()
plt.savefig("nn_roc_curve_baseline.png", dpi=300)
plt.close()
...
results.to_csv("nn_predictions_baseline.csv", index=False)